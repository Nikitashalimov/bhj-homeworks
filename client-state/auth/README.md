...
В третьем задании, после авторизации вам необходимо записать идентификатор пользователя в локальное хранилище, чтобы после обновления страницы выводилось сразу приветствие, а не форма авторизации (сответсвенно при загрузке страницы, тоже необходимо реализовать эту логику).